  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>Enter a YouTube URL and select your preferred format</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            {converting && (
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground text-center">Converting...</p>
              </div>
            )}
